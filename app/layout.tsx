...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "Andreas K",
    "karabetian.dev",
    "Andreas Karabetian Portfolio",
    "Andreas Karabetian Projects",
    "Andreas Karabetian Skills",
    "Andreas Karabetian Experience",
    "Andreas Karabetian Education",
    "Andreas Karabetian Blog",
    "Andreas Karabetian Resume",
  ],
  authors: [
    {
